...
RapporExamine.getBrowser = function() {
  var browser, parser;
...
RapporExamine.getPlugins = function() {
  var fprint, plugins;
  fprint = new RapporExamine.Fingerprint();
...
RapporExamine.getLanguage = function() {
  var fprint, keys;
  fprint = new RapporExamine.Fingerprint();
  keys = [];
...
RapporExamine.getTouchSupport = function() {
  var fprint, keys;
  fprint = new RapporExamine.Fingerprint();
  keys = [];
  fprint.touchSupportKey(keys);
  return keys[0].value[2];
};
