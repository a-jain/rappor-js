...
shinyUI(pageWithSidebar(
                        ...
                        sidebarPanel(
                                     tabsetPanel(#tabPanel("Input",
                                                          # fileInput('params', 'Select Params File',
                                                 ...
                                                 tabPanel("Privacy",
                                                          ...
                                                          br(),
                                                          htmlOutput("epsilon", align="center"),
                                                          br(),
                                                          helpText("* In addition to p, q and f, the number of hash functions also affects privacy guarantees."),
                                                          br(),
                                                          br(),
                                                          br()
                                                          )#,
                        ...
                        mainPanel(
                                  ...
                                  tags$head(tags$script(src="autorun.js"))
                                  )
                        ))
