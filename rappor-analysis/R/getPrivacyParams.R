...
sd(dat5[dat5$N==1000,]$refreshes) 

mean(dat5[dat5$N==10000,]$refreshes)
sd(dat5[dat5$N==10000,]$refreshes) 
mean(dat5[dat5$N==20000,]$refreshes)
sd(dat5[dat5$N==20000,]$refreshes) 
mean(dat5[dat5$N==30000,]$refreshes, na.rm=TRUE)
sd(dat5[dat5$N==30000,]$refreshes, na.rm=TRUE) 
mean(dat5[dat5$N==40000,]$refreshes)
sd(dat5[dat5$N==40000,]$refreshes) 
mean(dat5[dat5$N==50000,]$refreshes)
sd(dat5[dat5$N==50000,]$refreshes) 

mean_warms = c(mean(dat5[dat5$N==1000,]$warm), mean(dat5[dat5$N==10000,]$warm), mean(dat5[dat5$N==20000,]$warm), mean(dat5[dat5$N==30000,]$warm), mean(dat5[dat5$N==40000,]$warm))
mean_refreshes = c(mean(dat5[dat5$N==1000,]$refreshes), mean(dat5[dat5$N==10000,]$refreshes), mean(dat5[dat5$N==20000,]$refreshes), mean(dat5[dat5$N==30000,]$refreshes), mean(dat5[dat5$N==40000,]$refreshes))
xcoords = c(1000, 10000, 20000, 30000, 40000)
lm_warms = lm(mean_warms ~ xcoords)
lm_refreshes = lm(mean_refreshess ~ xcoords)
